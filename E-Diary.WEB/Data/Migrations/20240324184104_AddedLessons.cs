        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonOnDayNumber = table.Column<int>(type: "int", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Lessons", x => x.Id);
                    table.CheckConstraint("ValidLessonNumber", "LessonOnDayNumber > 1 AND LessonOnDayNumber < 10");
                    table.ForeignKey(
                        name: "FK_Lessons_TeacherGroupSubjects_LessonInfoId",
                        column: x => x.LessonInfoId,
