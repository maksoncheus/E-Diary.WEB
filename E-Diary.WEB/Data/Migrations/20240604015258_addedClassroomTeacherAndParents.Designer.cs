...
namespace E_Diary.WEB.Data.Migrations
{
    ...
    [Migration("20240604015258_addedClassroomTeacherAndParents")]
    partial class addedClassroomTeacherAndParents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Diary.WEB.Data.Entities.Admin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Diary.WEB.Data.Entities.CertificationPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CertificationPeriods");
                });

            modelBuilder.Entity("E_Diary.WEB.Data.Entities.Grade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Diary.WEB.Data.Entities.PeriodGrade", b =>
                {
                    ...
                    b.HasIndex("PeriodInfoId");

                    b.HasIndex("UserId");

                    b.ToTable("PeriodGrades");
                });

            modelBuilder.Entity("E_Diary.WEB.Data.Entities.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Diary.WEB.Data.Entities.StudyYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Diary.WEB.Data.Entities.Subject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Diary.WEB.Data.Entities.Teacher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Diary.WEB.Data.Entities.TeacherGroupSubject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Diary.WEB.Data.Entities.Grade", b =>
                {
                    b.HasOne("E_Diary.WEB.Data.Entities.Lesson", "Lesson")
                        .WithMany()
            ...
            modelBuilder.Entity("E_Diary.WEB.Data.Entities.PeriodGrade", b =>
                {
                    ...
                    b.HasOne("E_Diary.WEB.Data.Entities.TeacherGroupSubject", "PeriodInfo")
                        .WithMany()
                        .HasForeignKey("PeriodInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("E_Diary.WEB.Data.Entities.Student", b =>
                {
                    b.HasOne("E_Diary.WEB.Data.Entities.Group", "Group")
                        .WithMany()
            ...
            modelBuilder.Entity("E_Diary.WEB.Data.Entities.TeacherGroupSubject", b =>
                {
                    ...
                    b.HasOne("E_Diary.WEB.Data.Entities.Teacher", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("E_Diary.WEB.Data.Entities.YearGrade", b =>
                {
                    ...
                    b.HasOne("E_Diary.WEB.Data.Entities.TeacherGroupSubject", "YearInfo")
                        .WithMany()
