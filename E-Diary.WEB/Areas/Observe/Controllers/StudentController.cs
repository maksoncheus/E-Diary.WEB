...
namespace E_Diary.WEB.Areas.Observe.Controllers
{
    [Area("Observe")]
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Schedule(string id, string? date)
        {
            ...
            ObserveScheduleViewModel vm = new()
            {
                Id = id,
        ...
        public async Task<IActionResult> Grades(string id, int periodId = -1)
        {
            ...
            List<Subject> subjects = await _context.TeacherGroupSubjects
                ...
                .Distinct()
                .ToListAsync();
            return View(new ObserveGradesViewModel() { Id = id, Grades = grades, Subjects = subjects, StudyYear = year, CertificationPeriod = period });
        }
    }
}
