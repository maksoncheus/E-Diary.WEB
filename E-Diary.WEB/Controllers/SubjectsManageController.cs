...
{
    public class SubjectsManageController : Controller
    {
        private readonly ASPIdentityDBContext _context;

        public SubjectsManageController(ASPIdentityDBContext context)
        {
            _context = context;
        }
